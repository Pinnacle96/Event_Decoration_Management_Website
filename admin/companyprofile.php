                                        ...
                                        {  
                                            ...
                                            <div class="row"> 
                                                ...
                                                <div class="form-group row col-md-6">
                                                    ...
                                                    <div class="col-12">
                                                        <input type="text" class="form-control" name="mobilenumber" value="0<?php  echo $row->companyphone;?>" required='true' placeholder="Enter company contact no" maxlength='14'>
                                                    </div>
                                                </div>
                                            </div>
